...
interface SpielerHeaderProps {
  onAddSpieler: () => void;
}

const SpielerHeader = ({ onAddSpieler }: SpielerHeaderProps) => {
  return (
      ...
      <div className="relative z-10 px-8 py-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div className="flex-1">
            ...
            >
              Verwalten Sie Ihre Spieler, erstellen Sie neue Einträge und
              bearbeiten Sie bestehende Spielerdaten.
            </motion.p>
          </div>
